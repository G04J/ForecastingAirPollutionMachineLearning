...
Feel free to adapt paths when calling the scripts, especially where some helper scripts currently contain hard-coded paths pointing into a user-specific `Downloads/` directory.
